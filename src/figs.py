...
<svg viewBox="0 0 1060 436" role="img" aria-labelledby="fct">
  ...
  <g class="d-artifact">
    ...
    <text x="726" y="248">runtime attestation</text>
  ...
  <text class="s-sub" x="530" y="414" text-anchor="middle">Each step could be useful. None of them is the question anyone started with, and each is easier to fund than the judgment it stands in for.</text>
</svg>
...
<svg viewBox="0 0 1060 400" role="img" aria-labelledby="fdt">
  ...
  <text class="s-sub" x="530" y="391" text-anchor="middle">Coordination does not get cheaper because reasoning did.</text>
</svg>
...
<svg viewBox="0 0 1060 436" role="img" aria-labelledby="fft">
  ...
  <path class="d-cut" d="M40 146 H1040"/>
  <text class="d-cut-t" x="44" y="132">iteration is unavailable above this line</text>
...
<figcaption>Figure 3 &middot; Same library, same disclosure, same patch deadline, same scanner output, same audit result. One of these systems reissues its identity and the other does not, and no default instrument in the pipeline distinguishes them without architectural context.</figcaption>
</figure>
'''
